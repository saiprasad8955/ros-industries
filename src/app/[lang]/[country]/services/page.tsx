...
const ServiceColumn = ({
    ...
    return (
        <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-ros-blue transition-colors">{title}</h3>
    ...
    return (
        <div className="bg-white min-h-[calc(100vh-72px)]">
            ...
            <section className="relative overflow-hidden py-32">
                ...
                <div className="container-custom relative z-10 flex justify-center ">
                    <div className="text-center max-w-4xl mx-auto bg-white/80 p-8 md:p-12 rounded-[2.5rem] shadow-2xl border border-white/50">
                        <span className="inline-block py-1 px-3 rounded-full bg-ros-blue/10 border border-ros-blue/20 text-ros-blue text-xs font-bold uppercase tracking-wider mb-6">
                            Expert Support
                        </span>
            ...
            <section className="pb-24 pt-8">
                <div className="container-custom">
                    <div className="bg-ros-blue rounded-3xl p-12 text-center text-white relative overflow-hidden shadow-xl shadow-ros-blue/20">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-white/90 max-w-xl mx-auto mb-8 text-lg font-medium">
                            ...
                            <a href="#contact" className="inline-block bg-white text-ros-blue px-8 py-3.5 rounded-lg font-bold hover:bg-teal-50 hover:text-teal-700 transition-colors shadow-lg">
